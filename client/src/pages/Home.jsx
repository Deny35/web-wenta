        ...
        <section id="produkty" className="py-20 bg-slate-50">
          <div className="max-w-5xl mx-auto px-6">
            <ImageAccordion label="Co produkujemy" items={[
              ...
              { icon: '<path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/>', title: 'Zbiorniki nierdzewne', desc: 'Procesowe, magazynowe i ciśnieniowe – certyfikowane z dokumentacją UDT.',              img: '/co_produkujemy/Zbiorniki_nierdzewne.jpg' },
              ...
              { icon: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>',              title: 'SKID-y produkcyjne',   desc: 'Gotowe moduły procesowe z armaturą i osprzętem – plug & play.',                     img: '/co_produkujemy/SKID-y_produkcyjne.jpg' },
              { icon: '<path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>', title: 'Stacje mycia CIP', desc: 'Automatyczne mycie instalacji bez demontażu – z dokumentowanymi programami.', img: '/co_produkujemy/Stacje_mycia_CIP.jpg' },
