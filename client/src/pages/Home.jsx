        ...
        <section id="produkty" className="py-20 bg-slate-50">
          <div className="max-w-5xl mx-auto px-6">
            <ImageAccordion label="Co produkujemy" items={[
              { icon: '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>', title: 'Linie technologiczne',    desc: 'Kompletne linie produkcyjne ze stali nierdzewnej pod konkretny proces.',             img: '/znak_zapytania.jpg' },
              { icon: '<path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/>', title: 'Zbiorniki nierdzewne', desc: 'Procesowe, magazynowe i ciśnieniowe – certyfikowane z dokumentacją UDT.',              img: '/co_produkujemy/Zbiorniki_nierdzewne.png' },
              { icon: '<path d="M3 3h18v18H3z"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18"/>',  title: 'Instalacje rurowe',    desc: 'Rurociągi ze stali nierdzewnej i kwasoodpornej – sanitarne, technologiczne, CIP.',  img: '/znak_zapytania.jpg' },
              { icon: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>',              title: 'SKID-y produkcyjne',   desc: 'Gotowe moduły procesowe z armaturą i osprzętem – plug & play.',                     img: '/co_produkujemy/SKID-y_produkcyjne.png' },
              { icon: '<path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>', title: 'Stacje mycia CIP', desc: 'Automatyczne mycie instalacji bez demontażu – z dokumentowanymi programami.', img: '/co_produkujemy/Stacje_mycia_CIP.png' },
              { icon: '<path d="M12 22V12m0 0L8 8m4 4l4-4M4 6h16"/>',                         title: 'Mieszalniki przemysłowe', desc: 'Różne typy wirników – do roztworów, past, emulsji i zawiesin.',                   img: '/co_produkujemy/Mieszalniki_przemysłowe.png' },
              ...
              { icon: '<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>', title: 'Konstrukcje stalowe', desc: 'Platformy, podesty, schody i balustrady ze stali nierdzewnej.', img: '/co_produkujemy/Konstrukcje_stalowe.png' },
            ]} />
          </div>
        </section>
